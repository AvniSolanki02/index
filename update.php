...
if(isset($_GET['id'])){
    ...
    $query="SELECT * FROM `avni1` WHERE `id`=$id";
...
<body>
    <div class="row container"> 
        ...
        <div class="mt-2 col-md-12">
            ...
            <input onkeyup="fnvalidation()" name="fname" value="<?php echo $data['fname'];?>" type="text" class="form-control form-control-sm form"  id="Firststudent" placeholder="Enter First name">
            <label class="error-input">Required</label>
        </div>

        <div class="mt-2 col-md-12">
            <label for="username" class="form-label"><b>username <span class="star">*</span></b></label>
            <input onkeyup="uvalidation()" type="text" name="username" class="form-control form-control-sm form" value="<?php echo $data['username'];?>" id="username" placeholder="Enter username">
            <label class="error-input">Required</label>
        </div>
        <div class="mt-2 col-md-12">
            ...
            <input onchange="gendervalidation()" type="radio" <?php echo $Male ?> class="form-check-input form" value="Male" id="Male" name="gender">
                <label for="Male" class="form-check-label">
                    <b>Male</b>
                </label>
            </div>
            <div class="form-check form-check-inline">
                <input onchange="gendervalidation()" type="radio" <?php echo $Female ?> class="form-check-input form" value="Female" id="Female" name="gender">
    ...
    <div class="mt-2 col-md-12">
        ...
        <input onkeyup="emailvalidation()" type="email" class="form-control form-control-sm form" name="Email" value="<?php echo $data['email'];?>" id="Email" placeholder="Enter your Email">
        ...
        <div class="mt-2 col-md-12">
            ...
            <div class="col-md-10">
            <input onkeyup="phnvalidation()"type="phnumber" name="phnumber" value="<?php echo $data['phnumber'];?>" class="form-control" id="phone"  placeholder="phone number" required>
        ...
        <div class="col-sm-6">
            ...
            <input onkeyup="passwordvalidation()" type="password" class="form-control" name="password" value="<?php echo $data['pass'];?>" id="password" placeholder="password">
        ...
        <div class="col-sm-6">
            ...
            <input onkeyup="confirmpasswordvalidation()" type="password" class="form-control" name="password" value="<?php echo $data['confirmpassword'];?>" id="confirm-password" placeholder="confirm-password">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
            <img height="200px" width="200px"  src="./uploads/<?php echo $data['iname']; ?>" id="box">
            <input type="hidden" name="old_pic" value="<?php echo $data['iname']; ?>">
        </div>
      </div>
...
<script>
    ...
    input=document.getElementById("formfield");
